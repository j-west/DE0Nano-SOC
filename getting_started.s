...
/********************************************************************************
 * This program demonstrates use of parallel ports in the DE0-Nano-SoC Computer
 *
...
DO_DISPLAY:
				...
				ROR		R5, R5, #8				// the SW values are copied into the upper three bytes of the pattern register
				ORR		R4, R4, R5					// needed to make pattern consistent as all 32-bits of a register are rotated
